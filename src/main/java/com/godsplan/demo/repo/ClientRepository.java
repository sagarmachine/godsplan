...
public interface ClientRepository  extends JpaRepository<Client,Long> {
  ...
  //
    ...
    List<Object> getCountryCount();
        ...
        @Query(value="from Client where (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where  (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    Integer countByFirstNameContainingOrLastNameContainingOrEmailContainingOrderByCreatedOnDesc( String firstName,String lastName,String email);
        ...
        @Query(value="from Client where category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    Integer countByCategoryAndFirstNameContainingOrLastNameContainingOrEmailContainingOrderByCreatedOnDesc(String category,String firstName,String lastName,String email);
        ...
        @Query(value="from Client where country=:country AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where country=:country AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where country=:country AND  (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where country=:country AND  (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    //all verified not others
        ...
        @Query(value="from Client where verified=true AND  (Not publicFigure=:other)AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value=" select count(email) from Client where verified=true AND  (Not publicFigure=:other)AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where verified=false AND  (Not publicFigure=:other)AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value=" select count(email) from Client where verified=false AND  (Not publicFigure=:other)AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    //all particular public figure
        ...
        @Query(value="from Client where publicFigure=:publicFigure AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where publicFigure=:publicFigure AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where publicFigure=:publicFigure AND verified=true AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where publicFigure=:publicFigure AND verified=true AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where publicFigure=:publicFigure AND verified=false AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where publicFigure=:publicFigure AND verified=false AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    // ____________________________________________________by category
        ...
        @Query(value="from Client where verified=true AND (NOT publicFigure=:other) AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where verified=true AND (NOT publicFigure=:other) AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where verified=false AND (NOT publicFigure=:other) AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where verified=false AND (NOT publicFigure=:other) AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where  publicFigure=:publicFigure AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where  publicFigure=:publicFigure AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where verified=true AND  publicFigure=:publicFigure AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where verified=true AND  publicFigure=:publicFigure AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where verified=false AND  publicFigure=:publicFigure AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where verified=false AND  publicFigure=:publicFigure AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
...
//######################################## Country
    ...
    //all verified not others
        ...
        @Query(value="from Client where country=:country AND verified=true AND (NOT publicFigure=:other) AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
   ...
   @Query(value="select count(email) from Client where country=:country AND verified=true AND (NOT publicFigure=:other)  AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where country=:country  AND publicFigure=:publicFigure AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where country=:country  AND publicFigure=:publicFigure AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where country=:country AND verified=true AND publicFigure=:publicFigure AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where country=:country AND verified=true AND publicFigure=:publicFigure AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where country=:country AND verified=false AND publicFigure=:publicFigure AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where country=:country AND verified=false AND publicFigure=:publicFigure AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    // ____________________________________________________by category
        ...
        @Query(value="from Client where country=:country AND verified=true AND (NOT publicFigure=:other)AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where country=:country AND verified=true AND (NOT publicFigure=:other)AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where country=:country AND verified=false AND (NOT publicFigure=:other)AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where country=:country AND verified=false AND (NOT publicFigure=:other)AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where country=:country  AND publicFigure=:publicFigure AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where country=:country  AND publicFigure=:publicFigure AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where country=:country AND verified=true AND  publicFigure=:publicFigure AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where country=:country AND verified=true AND  publicFigure=:publicFigure AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where country=:country AND verified=false AND  publicFigure=:publicFigure AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="select count(email) from Client where country=:country AND verified=false AND  publicFigure=:publicFigure AND category=:category AND (firstName like %:firstName% OR lastName like %:lastName% OR email like %:email% OR name like %:email%)")
    ...
    @Query(value="from Client where  (NOT publicFigure=:other) AND (firstName like %:search% OR lastName like %:search% OR email like %:search% OR name like %:search%)")
    List<Client> findByPublicFigureIsNotOrderByCreatedOnDesc(String other,String search,Pageable pageable);
    @Query(value="select  count(email) from Client where  (NOT publicFigure=:other) AND (firstName like %:search% OR lastName like %:search% OR email like %:search% OR name like %:search%)")
    Integer countByPublicFigureIsNotOrderByCreatedOnDesc(String other,String search);

    @Query(value="from Client where country=:country AND (NOT publicFigure=:other) AND (firstName like %:search% OR lastName like %:search% OR email like %:search% OR name like %:search%)")
    ...
    @Query(value="select count(email) from Client where country=:country AND (NOT publicFigure=:other) AND (firstName like %:search% OR lastName like %:search% OR email like %:search% OR name like %:search%)")
    Integer countByPublicFigureIsNotAndCountryOrderByCreatedOnDesc(String other,String country,String search);


    @Query(value="from Client where claimed=true AND (firstName like %:search% OR lastName like %:search% OR email like %:search% OR name like %:search%)")
    List<Client> findByClaimedIsTrueOrderByClaimedOnDesc(String search,Pageable pageable);
    @Query(value="select count (email) from Client where claimed=true AND (firstName like %:search% OR lastName like %:search% OR email like %:search% OR name like %:search%)")
    Integer countByClaimedIsTrueOrderByClaimedOnDesc(String search);
